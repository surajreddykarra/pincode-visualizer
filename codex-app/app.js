const DATA_PATHS = {
  pins: "../codex-data/raw-data/pins.json",
  trie: "../codex-data/raw-data/pin-trie.json",
  groups: "../codex-data/raw-data/prefix-groups.json",
  map: "../codex-data/raw-data/india-outline.geojson",
};
